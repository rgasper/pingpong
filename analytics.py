...
def ML_fun(player):
    ...
    #Just checking self-validation at the moment
    ...
    weights = 'distance' #leaving out uniform because distance is always doing better
    ...
    plt.title("Win or Loss Classification (k = %i, weights = '%s')"
              % (k, weights))
    plt.show()
